...
- MatPlotLib as explained link:https://matplotlib.org/users/installing.html[here] or detailed below.
- PyVISA as explained link:https://pyvisa.readthedocs.io/en/master/getting.html[here] or detailed below.
